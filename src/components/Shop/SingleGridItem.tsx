...
const SingleGridItem = ({ item }: { item: Product }) => {
  ...
  return (
    <div className="group">
      <div className="relative overflow-hidden flex items-center justify-center rounded-lg bg-gray-100 dark:bg-gray-800 shadow-1 min-h-[270px] mb-4">
        {/* === PERUBAHAN DI SINI: Logika untuk menampilkan gambar atau placeholder === */}
        {imageUrl ? (
          <Image 
            src={imageUrl} 
