...
const Header = () => {
  ...
  const initialCategory = searchParams.get("category") || "0";
  ...
  useEffect(() => {
    ...
    setSelectedCategory(searchParams.get("category") || "0");
  }, [searchParams]);
              ...
              <form onSubmit={handleSearchSubmit}>
                <div className="flex items-center">
                  <CustomSelect
                    ...
                    onChange={(value) => setSelectedCategory(String(value))} // Pastikan value selalu string
                  />
              ...
              <div className="flex items-center gap-5">
                {session ? (
                  <div className="flex items-center gap-2.5">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="text-dark" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="flex flex-col">
                      ...
                      <button onClick={() => signOut()} className="text-xs text-blue-600 underline mt-1 text-left">
                        Sign Out
                      </button>
                    </div>
                  </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="hidden xl:block">
              <ul className="flex items-center gap-5.5">
                ...
                <li className="py-4">
                  <Link href="/orders" className="flex items-center gap-1.5 font-medium text-custom-sm text-dark hover:text-blue">
